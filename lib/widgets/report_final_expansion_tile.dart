...
class ReportFinalExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ReportFinalExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
  ...
  @override
  _ReportFinalExpansionTileState createState() =>
      _ReportFinalExpansionTileState();
}

class _ReportFinalExpansionTileState extends State<ReportFinalExpansionTile>
