...
class ReportExpasionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ReportExpasionTile({
    Key key,
    this.leading,
    @required this.title,
  ...
  @override
  _ReportExpasionTileState createState() => _ReportExpasionTileState();
}

class _ReportExpasionTileState extends State<ReportExpasionTile>
          ...
          GestureDetector(
            ...
            child: Padding(
              padding: EdgeInsets.only(
                  left: 29.0.w, right: 39.w, top: 5.h, bottom: 5.h),
              child: Row(
                children: [
                  widget.title,
                  SizedBox(
